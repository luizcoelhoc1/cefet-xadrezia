 ...
 * @author Luiz
 */
public class RunnableCalcJogadaPreta implements Runnable, Comparable<RunnableCalcJogadaPreta> {

    private Movimento movimento;
    private int pontos;
    private Tabuleiro tabuleiroAtual;

    public RunnableCalcJogadaPreta(Movimento movimento, Tabuleiro tabuleiroAtual) {
    ...
    private int getValor(Tabuleiro tabuleiro) {
        ...
        return valorPreta - valorBranca;
    }

    @Override
    public int compareTo(RunnableCalcJogadaPreta t) {
